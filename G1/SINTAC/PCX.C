...
void borra_paleta(int num_colores);
...
/****************************************************************************
	BORRA_PALETA: rellena todas las entradas de la paleta de negro.
	  Entrada:      'num_colores' n£mero de colores en la paleta
****************************************************************************/
void borra_paleta(int num_colores)
{
BYTE paleta_negro[256][3];
int i;
...
carga_paleta(&paleta_negro[0][0],num_colores);
...
else if(modo==PCX_OCULTA) borra_paleta(16);
...
/* si quiere que la imagen no se vea, pone a 0 toda la paleta */
else if(modo==PCX_OCULTA) borra_paleta(256);
