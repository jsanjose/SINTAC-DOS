...
static void v_guardafondo(BYTE _far *fondo, short fil, short col, short ancho,
  short alto);
static void v_recuperafondo(BYTE _far *fondo, short fil, short col,
...
****************************************************************************/
void v_guardafondo(BYTE _far *fondo, short fil, short col, short ancho,
  short alto)
{
...
****************************************************************************/
void v_recuperafondo(BYTE _far *fondo, short fil, short col, short ancho,
  short alto)
{
BYTE _far *pscr=(BYTE _far *)0xb8000000;
BYTE _far *p;
...
{
BYTE _far *pscr0=(BYTE _far *)0xb8000000;
BYTE _far *pscr;
int i, s, anch, alt;
